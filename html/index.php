...
<head>
  ...
  <script defer src="../node_modules/bootstrap/dist/js/bootstrap.bundle.js"></script> <!-- for dropmenu it must included -->
...
<body>
  <!-- Modal -->
  <div class="modal fade" id="sign-in-modal" tabindex="-1" aria-labelledby="head-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header remove-separator-modal">
          <button type="button" class="btn-close sign-in-btn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="tab-content" id="myTabContent">
            <div id="sign-in-form">
              ...
              <form method="post" action="index.php" id="form-sign" novalidate>
                <div class="form-floating mb-3 form-group">
                  <input type="email" class="form-control" id="floatingInput" name="email" placeholder="name@example.com" required />
                  <label for="floatingInput" class="color-333">البريد الإلكتروني</label>
                  <div class="invalid-feedback">
                    البريد الإلكتروني الذي أدخلته غير مرتبط بحساب.
                  </div>
                </div>
                <div class="form-floating">
                  <input type="password" class="form-control password-field form-group" id="floatingPassword" name="password" placeholder="Password" required />
                  <label for="floatingPassword" class="color-333">كلمة المرور</label>
                  <div class="invalid-feedback" id="incorrect-password">
                    كلمة السر التي أدخلتها غير صحيحة.
                  </div>
                </div>
                <input type="submit" id="login-submit" class="btn sign-in-btnn" value="تسجيل الدخول" />
              </form>
              <p class="text-center pt-3">
                <a class="forgot-password" href="#" onclick=" return toSignForgot()">نسيت كلمة السر؟</a>
              </p>
              <p class="text-black-50 text-center">
                ليس لديك حساب؟
                <a href="#" class="sign-up-btnn" id="tasjel" onclick=" return toSignUp()">تسجيل</a>
              </p>
            </div>

            <div id="sign-up-form">
              <h1 class="text-center bold pb-3">إنشاء حساب في آجار</h1>
              <form onsubmit="return validateUp()" action="index.php" id="form-signUp" method="POST" novalidate>
                <div class="d-flex name-container">
                  <div class="form-floating mb-3 flex-fill">
                    <input type="text" class="form-control" id="floatingInput1" placeholder="name@example.com" name="upFirstName" required />
                    <label for="floatingInput1" class="color-333">الاسم الأول</label>
                  </div>
                  <div class="form-floating mb-3 flex-fill">
                    <input type="text" class="form-control" id="floatingInput2" name="upLastName" placeholder="name@example.com" required />
                    <label for="floatingInput2" class="color-333">اسم العائلة</label>
                  </div>
                </div>
                <div class="form-floating mb-3">
                  <input type="email" class="form-control" id="floatingInput3" name="upEmail" placeholder="name@example.com" required />
                  <label for="floatingInput3" class="color-333">البريد الإلكتروني</label>

                </div>
                <div class="form-floating mb-3">
                  <input type="tel" class="form-control" id="floatingInput4" maxlength="10" minlength="10" name="upPhone" placeholder="name@example.com" required />
                  <label for="floatingInput4" class="color-333">رقم الهاتف المحمول</label>
                  <div class="invalid-feedback">
                ...
                <div class="form-floating">
                  <input type="password" class="form-control password-field" id="floatingPassword1" name="upPassword" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required />
                  <label for="floatingPassword1" class="color-333">كلمة السر الجديدة</label>
                  <div class="invalid-feedback">
                    الرجاء ادخال رقم يحتوي على 8 أحرف أو أكثر بحيث تتكون من رقم واحد على الأقل ، وحرف واحد كبير و صغير
                  </div>
                </div>
                <input type="submit" class="btn sign-in-btnn" value="إنشاء حساب" />
              </form>

              <p class="text-black-50 pt-4 text-center have-acount">
                هل لديك حساب بالفعل؟
                <a href="#" class="sign-up-btnn" onclick=" return toSignIn()">تسجيل الدخول</a>
              </p>
            </div>
            <div id="forgot-formm">
              <h1 class="color-333 text-center bold pb-3 bold">
              ...
              <form onsubmit="return validateForgot()" action="index.php" id="form-forgot" novalidate>
                <div class="form-floating mb-3 form-group">
                  <input type="email" class="form-control" id="floatingInput11" placeholder="name@example.com" required />
                  <label for="floatingInput11" class="color-333">البريد الإلكتروني</label>
                  <div class="invalid-feedback">
                    البريد الإلكتروني الذي أدخلته غير مرتبط بحساب.
                  </div>
                </div>
              ...
              <p class="text-center pt-3">
                <a class="forgot-password" href="#" onclick="return toSignIn()">تسجيل الدخول</a>
              </p>
            </div>
          </div>
        </div>
  ...
  <div class="base-container bg">
    ...
    <main class="main-container">
      <section class="section-hero">
        <div id="demo" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="9000">
          <div class="carousel-indicators">
            <button type="button" data-bs-target="#demo" data-bs-slide-to="0" class="active bg-black"></button>
            <button type="button" data-bs-target="#demo" data-bs-slide-to="1" class="bg-black"></button>
            <button type="button" data-bs-target="#demo" data-bs-slide-to="2" class="bg-black"></button>
          </div>
          <div class="carousel-inner">
            <div class="carousel-item active" id="first-page">
              <img id="img1" src="../assets/imgs/web images/table 1457 360.png " alt="Los Angeles" class="d-block img" style="width: 100%" />
            ...
            <div class="carousel-item" id="second-page">
              <img id="img2" src="../assets/imgs/web images/shoes fv.png" alt="Chicago" class="d-block img" style="width: 100%" />
              <div class="carousel-caption">
                <h3>Chicago</h3>
            ...
            <div class="carousel-item" id="third-page">
              <img id="img3" src="../assets/imgs/web images/table 1457 360.png" alt="New York" class="d-block img" style="width: 100%" />
              <div class="carousel-caption">
                <h3>New York</h3>
