        ...
        <div id="demo" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="9000">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" id="first-page">
              <img id="img1" src="../assets/imgs/web images/static web images/bicycle.jpg " alt="Los Angeles" class="d-block img" style="width: 100%" />
            ...
            <div class="carousel-item" id="second-page">
              <img id="img2" src="../assets/imgs/web images/static web images/dreses.webp" alt="Chicago" class="d-block img" style="width: 100%" />
              <div class="carousel-caption mt-5 textShadow ms-5">
                <h1>آجار هو منصة لبيع وتأجير أي شيء في أي مكان</h1>
              </div>
            </div>
            <div class="carousel-item" id="third-page">
              <img id="img3" src="../assets/imgs/web images/static web images/camera.jpg" alt="New York" class="d-block img" style="width: 100%" />
              <div class="carousel-caption mt-5 textShadow ms-5">
            ...
            <div class="slide-content<?php echo $numSliders ?>" id="slides-group">
              ...
              <div class="card-wrapper swiper-wrapper">
                ...
                while ($cardData = mysqli_fetch_assoc($resultt)) {
                  if (in_array($cardData['item_id'], $added_items)) {
                    continue;
                  }
                  array_push($added_items, $cardData['item_id']);
                ?>
